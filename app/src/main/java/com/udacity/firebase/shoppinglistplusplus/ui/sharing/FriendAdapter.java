...
public class FriendAdapter extends FirebaseListAdapter<User> {
    ...
    protected void populateView(View view, final User friend) {
        ...
        // you should:
        //
        // 1.   Update the R.id.button_toggle_share button to the apropriate image resource, either
        //      R.drawable.ic_shared_check or R.drawable.icon_add_friend.
        // 2.   Call the updateFriendValueInSharedWithOfAllLists with either null for friendToAddHashMap
        //      if you are removing the friend from the shared list, or a HashMap representation of the
        //      friend if you're adding them.
    }
